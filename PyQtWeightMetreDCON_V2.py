...
#        self.figVIN.autofmt_xdate()
        ...
        VINlowerY=min(s['Date'][0][-1000:])-0.01
        VINupperY=max(s['Date'][0][-1000:])+0.01
        
        VINlowerX=x_axis[0]
        VINupperX=x_axis[-1:][0]
        
#        print(VINlowerY,VINlowerY,(VINupperY-VINlowerY)/10,VINlowerX,VINupperX,(VINupperX-VINlowerX)/10)
        self.axesVIN.set_ybound(lower=VINlowerY, upper=VINupperY)
...
#            self.axesVsup.set_xbound(lower=len(s['Vsup'][0])-minlen, upper=len(s['Vsup'][0]))            
        self.axesVsup.set_ybound(lower=min(s['Vsup'][0][-1000:])-0.01, upper=max(s['Vsup'][0][-1000:])+0.01)
